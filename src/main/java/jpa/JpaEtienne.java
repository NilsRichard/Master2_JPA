...
//			jpa.listCards();
    ...
    private void populate() {
        int nb = manager.createQuery("select b from BoardKB b", BoardKB.class).getResultList().size();
    ...
    private void listCards() {
        List<CardKB> resultList = manager.createQuery("Select c From CardKB c", CardKB.class).getResultList();
